...
class ApexAgentPage extends StatefulWidget {
  const ApexAgentPage({Key? key}) : super(key: key);

  @override
  State<ApexAgentPage> createState() => _ApexAgentPageState();
}

class _ApexAgentPageState extends State<ApexAgentPage>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      drawer: NavBar(pageName: '/apex_agents'),
      body: Container(
